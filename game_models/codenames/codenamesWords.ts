...
/** The Codenames word pool (399 words). Each game draws 25 at random. */
export const WORDS: readonly string[] = [
  ...
  "LION", "LITTER", "MONSTER", "LOCK", "LOG", "LONDON", "LUCK", "MAIL", "MAMMOTH", "MAPLE",
  ...
  "NEEDLE", "NET", "CANNON", "NIGHT", "NINJA", "NOTE", "NOVEL", "NURSE", "NUT", "OCTOPUS",
